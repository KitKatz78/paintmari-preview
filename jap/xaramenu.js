// Clean Text-Based Menu Engine (Japanese)
var lastWasMain = false;

function startMainMenu() { 
    document.write('<div class="modern-menu">');
    document.write('<button type="button" class="mobile-menu-toggle" aria-expanded="false">ナビゲーション</button>');
...
function mainMenuItem(id, label, url) {
    ...
    if ((fileName === "" || fileName === "indexjap.htm") && url === "indexjap.htm") {
        activeClass = " active";
